  ...
  return (
    ...
    <div ref={ref}>
      <div className="msh-segmented msh-segmented-sm css-23bs09 css-var-r1">
        <div className="msh-segmented-group">
          <label className="msh-segmented-item flex items-center space-x-1 m-2 w-[200px]">
            ...
            >
              <div className="msh-segmented-item-label">{('handDrawn')}</div>
            </div>
          </label>
        </div>
      </div>
      {
        svgCode
            && <div 
            // className="mermaid cursor-pointer h-auto w-full object-fit: cover" 
            style={{
              cursor: 'pointer',
              height: 'auto',
              width: '100%',
      ...
      }
      {
        errMsg
            && <div className='py-4 px-[26px]'>
              <WarningOutlined className='w-6 h-6 text-red-500'/>
              &nbsp;
              {errMsg}
            </div>
      }
